...
import { createSalaries, getSalaries, updateSalary } from './controllers/salariesController.js';
import { createUsers, deleteUsers, getUsers, updateCustomer } from './controllers/userController.js';
import { createExpense, deleteExpense, getExpensesByCategory, updateExpense } from './controllers/expenseController.js';
...
app.put('/products/update/:productId',middleware, updateProduct);
app.put('/salaries/:userId', middleware, updateSalary);
app.put('/customers/:userId', middleware, updateCustomer);
app.put('/expenses/:expenseId', middleware, updateExpense);
